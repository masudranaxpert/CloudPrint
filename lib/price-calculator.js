 ...
 * - Slides per page: 1, 2, 4, or 6 slides fit on 1 page
 ...
 * @param {number} slidesPerPage - How many slides to fit per page (1, 2, 4, or 6)
 ...
 * @param {number} params.slidesPerPage - 1, 2, 4, or 6
...
export function generateWhatsAppUrl(phone, orderData) {
    ...
    message += `\n\nCloudPrint ব্যবহার করার জন্য ধন্যবাদ — আপনার ব্রাউজার থেকেই দ্রুত, সহজ এবং শিক্ষার্থীবান্ধব প্রিন্টিং সেবা।`;
